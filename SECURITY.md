...
- **GitHub Security Advisory**: Use the [Security tab](https://github.com/stonyp90/Usrly-Agent/security/advisories/new) in the repository
...
- **Keep Ursly Agent updated** to the latest version
- **Use strong, unique credentials** for Keycloak and MongoDB
...
- **Never commit secrets** (API keys, passwords, tokens, JWT secrets) to the repository
...
Thank you for helping keep Ursly Agent and our users safe!
